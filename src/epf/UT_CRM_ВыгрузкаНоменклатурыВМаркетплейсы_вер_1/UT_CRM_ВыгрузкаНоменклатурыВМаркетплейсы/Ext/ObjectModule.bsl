...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, "Открыть форму : UT_CRM_ВыгрузкаНоменклатурыВМаркетплейсы","UT_CRM_ВыгрузкаНоменклатурыВМаркетплейсы",ТипКоманды, Ложь) ;
	
	ТипКоманды = ДополнительныеОтчетыИОбработкиКлиентСервер.ТипКомандыВызовСерверногоМетода();
	ДобавитьКоманду(ПараметрыРегистрации.Команды, "Экспорт доступных остатков","UT_CRM_ВыгрузкаНоменклатурыВМаркетплейсы",ТипКоманды, Ложь) ;
...
Процедура ВыполнитьКоманду(ИмяКоманды, ПараметрыВыполнения) Экспорт
	...
	Если ИмяКоманды = "UT_CRM_ВыгрузкаНоменклатурыВМаркетплейсы" Тогда
		ВыполнитьЭкспорт();
	КонецЕсли;
